...
export const TOPIC_STRATEGY_PROMPT_TEXT = `# Role
...
# Context
我们需要为【[填入高校名称]】的官方微信公众号策划下一阶段的推文选题。
当前时间：2026年3月（春季学期，涵盖开学、考研复试、春招、毕业季预热等节点）。
目标受众：在校本科生/研究生、潜在考生（高中生及家长）、广大校友。
# Goal
请根据下方的【选题类型矩阵】，为我生成 5-8 个具体的软文选题方案。每个方案必须包含标题、核心切入点、情感/价值锚点以及预期的传播效果。
# Strategy: The "Heart-Mind-Smile" Framework
在构思选题时，必须严格遵循以下三个维度之一作为核心驱动力：
1. **让用户动心 (Emotional Resonance)**：触发集体记忆、身份认同或情感共鸣（如：乡愁、成长焦虑、师生情、校园独家记忆）。参考案例风格：天津大学《Are you 硕？I'm 天大硕！》。
2. **对用户有用 (Practical Utility)**：解决具体痛点，提供稀缺信息或生存指南（如：避坑指南、办事流程、升学就业干货）。
3. **让用户会心一笑 (Humor & Relatability)**：用自嘲、梗文化或反差萌解构严肃话题，拉近与年轻人的距离。
# Workflow & Categories
请针对以下五大类别，分别运用上述策略进行头脑风暴：
## 1. 新闻资讯类 (软化处理)
- **要求**：拒绝通稿风。将学校成就、政策发布转化为"与人有关"的故事。
- **思考方向**：新闻背后的普通人故事？数据对个体命运的改变？
## 2. 招生宣传类 (种草与愿景)
- **要求**：拒绝说教。展示"在这里生活是什么感觉"，而非"我们有多牛"。
- **思考方向**：第一人称体验、宿舍/食堂的隐藏玩法、学长学姐的真实独白。
## 3. 热点借势类 (校园化落地)
- **要求**：结合2026年当下的社会/网络热梗，强行关联校园场景，但要自然不尴尬。
- **思考方向**：影视剧台词改编、网络挑战校园版、节气/节日的情感投射。
## 4. 实用指南类 (痛点狙击)
- **要求**：标题要直击焦虑，内容要保姆级教程。
- **思考方向**：考研/考公/求职的至暗时刻如何度过？校园生活冷知识？
## 5. 校园故事类 (深度共情)
- **要求**：挖掘小人物的大情怀，或平凡日子的闪光点。
- **思考方向**：保安/宿管阿姨的故事、实验室的深夜灯光、一对情侣的奋斗史。
# Output Format
请以表格形式输出，包含以下列：
...
- 语气要年轻化、真诚，拒绝官腔。
- 必须结合2026年的时间背景（如：AI普及后的学习变化、后疫情时代的社交习惯等）。
